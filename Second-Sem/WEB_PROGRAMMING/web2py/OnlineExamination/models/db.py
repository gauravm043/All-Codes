...
db.define_table('questions',
	  ...
	  Field('que_number','integer',notnull=True),
	  Field('question','string',notnull=True),
	  Field('option_a','string',notnull=True),
	  Field('option_b','string',notnull=True),
	  Field('option_c','string',notnull=True),
	  Field('option_d','string',notnull=True),
	  Field('ans',requires=IS_IN_SET(['A','B','C','D'],multiple=True),widget=SQLFORM.widgets.checkboxes.widget),
	  Field('maxmarks','integer',notnull=True),
...
db.define_table('times',
	  Field('course',requires=IS_IN_DB(db,'courses.id','courses.name')),
	  Field('date_of_exam','string',notnull=True),
